...
var KTApp = function() {
    ...
    var initPopover = function(el) {
        ...
        .on('shown.bs.popover', function () {
            if (el.data('hide-on-outside-click') == 'true') {
                $('body').data('shown-popover', $(this));
            }
        })
        .popover({
            trigger: triggerValue,
        ...
        $('html').click(function () {
            var popover = $('body').data('shown-popover');
            if (popover) {
                popover.popover('hide');
                $('body').data('shown-popover', null);
            }
        })
    }
